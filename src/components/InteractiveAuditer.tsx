...
export default function InteractiveAuditer() {
  ...
  return (
    <section id="strategy" className="bg-[#050505] border-b border-white/10 text-white py-24 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto space-y-12 relative z-10">
        ...
        <div className="text-center space-y-4">
          <div className="inline-flex items-center space-x-1 bg-cyan-950/40 border border-cyan-900/40 px-3 py-1 text-cyan-400 text-xs font-mono font-bold tracking-widest uppercase">
        ...
        {/* Console Box Layout */}
        <div className="bg-[#050505] border border-white/10 rounded-lg overflow-hidden shadow-2xl">
          ...
          <div className="bg-neutral-950 px-6 py-4 border-b border-white/10 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-mono text-xs text-neutral-400 ml-2 tracking-widest font-bold">
                martin-walker-ai-core.exe
              </span>
            </div>
            <span className="font-mono text-[10px] text-cyan-400 font-bold bg-cyan-950/50 border border-cyan-900/40 px-2 py-0.5 animate-pulse uppercase">
              // Live Node
            </span>
          </div>
              ...
              {!loading && !result && !error && (
                ...
                >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-[#050505] border border-white/10 hover:border-neutral-700 focus:border-cyan-400 focus:outline-none transition-colors px-4 py-3 text-neutral-200 text-sm font-sans"
                        />
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          placeholder="e.g., St Albans, West London, Harrogate"
                          className="w-full bg-[#050505] border border-white/10 hover:border-neutral-700 focus:border-cyan-400 focus:outline-none transition-colors px-4 py-3 text-neutral-200 text-sm font-sans"
                        />
                  ...
                  <div className="pt-4">
                    <button
                      type="submit"
                      className="w-full py-4 bg-cyan-400 hover:bg-white text-black font-mono text-xs font-black tracking-widest transition-all duration-200 cursor-pointer flex items-center justify-center space-x-2 animate-pulse"
                    >
                      <Sparkles className="w-4 h-4 text-black" />
                      <span>INITIALIZE CORE COMPILATION ENGINE &rarr;</span>
                    </button>
                ...
                >
                    ...
                    {logs.slice(0, loadingStep + 1).map((log, idx) => (
                      <div 
                        ...
                        className={`flex items-start space-x-2 duration-300 ${
                          idx === loadingStep ? "text-cyan-400 font-bold" : "text-neutral-400"
                        }`}
                      >
                  ...
                  <div className="space-y-2 bg-[#050505] p-4 border border-white/10">
                    ...
                    <div className="w-full h-1.5 bg-neutral-900 border border-white/10">
                      <div 
                        className="h-full bg-cyan-400 duration-500"
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        onClick={handleReset}
                        className="p-2 sm:px-3 sm:py-1.5 bg-neutral-950 border border-white/10 hover:border-white text-cyan-400 hover:text-white font-mono text-xs flex items-center space-x-1.5 transition duration-200 cursor-pointer"
                      >
                  ...
                  <div className="space-y-4">
                    {result.steps.map((step, idx) => (
                      <div 
                        key={idx} 
                        className="bg-neutral-950 border border-white/10 p-5 rounded relative group hover:border-[#6fffe9]/30 transition duration-350"
                      >
                        <span className="absolute top-5 right-5 font-mono text-2xl text-neutral-800 font-bold group-hover:text-cyan-500/20 transition duration-300">
                          0{idx+1}
                        </span>
                        ...
                        <div className="space-y-2 max-w-[90%]">
                          ...
                          <h4 className="text-base font-bold tracking-tight text-white group-hover:text-cyan-400 duration-300">
                            {step.title}
                          </h4>
                  ...
                  <div className="bg-neutral-950 border-l-2 border-cyan-400 p-5 italic text-sm text-neutral-350 font-sans relative">
                    ...
                    <span className="block mt-2 font-mono text-[10px] text-cyan-400 not-italic uppercase font-bold tracking-wider text-right">
                      &mdash; Martin Walker, Strategy Lead, Marketni
                    </span>
                  </div>

                  {/* Immediate outreach trigger */}
                  <div className="bg-cyan-950/20 border border-cyan-900/30 p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="space-y-1">
                      <span className="font-mono text-[10px] text-cyan-400 font-bold uppercase tracking-widest block font-bold">
                    ...
                    <a
                      href="#contact"
                      className="px-5 py-2.5 bg-cyan-400 text-black hover:bg-white transition duration-200 font-mono text-xs font-black text-center tracking-widest shrink-0"
                    >
