      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 bg-black/95 backdrop-blur-lg flex items-center justify-center p-4 overflow-y-auto"
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-xl bg-neutral-950 border border-white/10 rounded-2xl p-6 md:p-8 shadow-2xl overflow-hidden my-8"
